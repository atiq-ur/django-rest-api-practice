...
SECRET_KEY = 'django-insecure-2c$y*emz&s#qvu$+9k+pab8y5rgscoabs-__@i$-(5eteixy3#'
...
if DATABASE_ENGINE == 'sqlite':
    ...
    raise ValueError("Invalid DATABASE_ENGINE specified in the .env file. Use 'sqlite' or 'postgres'.")
...
EMAIL_USE_TLS = False
EMAIL_USE_SSL = False
DEFAULT_FROM_EMAIL = config('MAIL_FROM_ADDRESS', default='<EMAIL>')
